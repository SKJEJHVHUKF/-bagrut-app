    ...
    >
      ...
      >
        <div className="flex-shrink-0 w-7 h-7 rounded-lg bg-violet-500/25 border border-violet-400/40 flex items-center justify-center">
          <Wrench className="w-3.5 h-3.5 text-violet-800" />
        </div>
        <div className="flex-1 min-w-0">
          <div className="text-sm font-black text-violet-800 chat-md">
          ...
          <div className="bg-slate-900/[0.03] border border-slate-900/10 rounded-xl px-4 py-3 space-y-2.5">
            ...
            <ol className="space-y-2">
              {technique.workedExample.steps.slice(0, stepsShown).map((step, i) => (
                ...
                >
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-violet-500/25 border border-violet-400/40 flex items-center justify-center text-[10px] font-black text-violet-800 mt-0.5">
                    {i + 1}
                  </div>
