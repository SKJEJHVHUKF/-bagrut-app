  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-3 space-y-3">
        ...
        {/* Strategy */}
        <div>
          <div className="text-[10px] font-black tracking-widest text-emerald-700 uppercase flex items-center gap-1.5 mb-1.5">
          ...
          <ol className="space-y-1.5">
            {pattern.strategy.map((s, i) => (
              <li key={i} className="flex gap-2 text-sm text-slate-800 leading-relaxed">
                <span className="flex-shrink-0 w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-400/40 flex items-center justify-center text-[10px] font-black text-emerald-800 mt-0.5">
                  {i + 1}
                </span>
                <div className="chat-md flex-1">
                  <MathText>{s}</MathText>
        ...
        {pattern.example && (
          <div className="bg-slate-900/[0.03] border border-slate-900/10 rounded-xl overflow-hidden">
            <button
