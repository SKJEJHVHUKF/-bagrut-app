        ...
        <div className="px-4 pb-4 space-y-3">
            ...
            {example.steps.slice(0, stepsShown).map((step, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="chat-md text-xs text-slate-600 leading-relaxed mt-1 border-r-2 border-violet-500/30 pr-2.5">
                    <span className="font-bold text-violet-800">למה: </span>
          ...
          {!allShown ? (
            <motion.button
              ...
              className="w-full inline-flex items-center justify-center gap-2 bg-violet-500/15 hover:bg-violet-500/25 border border-violet-500/40 px-4 py-2.5 rounded-xl font-bold text-violet-800 text-sm transition-all"
            >
