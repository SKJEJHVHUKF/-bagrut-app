  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-2">
        <button
          onClick={() => load(difficulty)}
          className="inline-flex items-center justify-center gap-2 bg-gradient-to-l from-violet-600 to-violet-600 hover:from-violet-500 hover:to-violet-500 px-4 py-3 rounded-2xl font-bold text-white shadow-lg shadow-violet-500/30 transition-all text-sm"
        >
        ...
        <button
          onClick={() => load('harder')}
          className="inline-flex items-center justify-center gap-2 bg-slate-900/[0.03] hover:bg-slate-900/5 border border-slate-900/10 hover:border-violet-500/40 px-4 py-3 rounded-2xl font-bold text-violet-800 text-sm transition-all"
        >
