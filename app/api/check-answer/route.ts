...
4) אם התשובה שגויה או חלקית — סווג את הטעות לאחת מהקטגוריות הבאות בדיוק (שדה category): "טעות סימן", "תחום הגדרה", "גזירה פנימית", "הנחת יסוד גיאומטרית", "טעות אלגברית", "טעות חשבונית", "שכחת תנאי", "אחר". אם התשובה נכונה — החזר category = "אחר".
...
const RESPONSE_SCHEMA = {
  ...
  required: ['verdict', 'feedback', 'tip', 'category'],
