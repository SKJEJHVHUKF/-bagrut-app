...
export default function BagruyotLandingPage() {
  ...
  return (
    <main className="min-h-screen px-4 sm:px-6 py-8 max-w-3xl mx-auto">
      ...
      {/* Hero */}
      <header className="space-y-3 mb-8 text-center sm:text-right">
        <div className="text-xs font-black tracking-widest text-emerald-300 uppercase flex items-center gap-2 justify-center sm:justify-start">
      ...
      <section className="space-y-3 mb-8">
        <h2 className="text-xs font-black tracking-widest text-slate-400 uppercase">איך זה עובד</h2>
        <FeatureCard
      ...
      {samplePart && sampleQuestion && (
        <section className="mb-8">
          <h2 className="text-xs font-black tracking-widest text-slate-400 uppercase mb-3">דוגמית</h2>
      ...
      <section className="mb-6">
        {!isLoggedIn ? (
          <Link
            ...
            className="card-3d block bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/50 hover:border-purple-400 rounded-2xl p-5 transition-all"
          >
          ...
          <div className="card-3d bg-gradient-to-br from-amber-600/15 to-orange-600/15 border border-amber-500/40 rounded-2xl p-5">
          ...
          <Link
            ...
            className="card-3d block bg-gradient-to-br from-emerald-600/20 to-teal-600/20 border border-emerald-500/50 hover:border-emerald-400 rounded-2xl p-5 transition-all"
          >
            <div className="flex items-center justify-between gap-3">
              <div>
