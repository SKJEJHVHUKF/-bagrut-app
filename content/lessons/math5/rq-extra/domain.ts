  ...
  },
  {
    ...
    solution: {
      steps: [
        ...
        '```signtable\n{"cols":[{"range":"$x < -6$"},{"point":"$x = -6$","note":"מחוץ לתחום"},{"range":"$-6 < x < 6$"},{"point":"$x = 6$","note":"מחוץ לתחום"},{"range":"$x > 6$"}],"rows":[{"label":"$6 + x$","cells":["-","0","+","+","+"]},{"label":"$6 - x$","cells":["+","+","+","0","-"]},{"label":"המכפלה","cells":["-","out","+","out","-"],"result":true}]}\n```',
  ...
  // ───────── mid · שתי מדרגות חדשות בדרך אל הבגרות ─────────
  {
    ...
    solution: {
      steps: [
        ...
        '```signtable\n{"cols":[{"range":"$x < -3$"},{"point":"$x = -3$","note":"מחוץ לתחום"},{"range":"$-3 < x < 1$"},{"point":"$x = 1$","note":"מתאפס"},{"range":"$x > 1$"}],"rows":[{"label":"$x - 1$","cells":["-","-","-","0","+"]},{"label":"$x + 3$","cells":["-","0","+","+","+"]},{"label":"המנה","cells":["+","out","-","0","+"],"result":true}]}\n```',
  ...
  // ───────── mid · המדרגה שלפני הבגרות ─────────
  {
    ...
    solution: {
      steps: [
        ...
        '```signtable\n{"cols":[{"range":"$x<-3$"},{"point":"$x = -3$","note":"מתאפס"},{"range":"$-3<x<2$"},{"point":"$x = 2$","note":"מחוץ לתחום"},{"range":"$2<x<3$"},{"point":"$x = 3$","note":"מתאפס"},{"range":"$x>3$"}],"rows":[{"label":"$x + 3$","cells":["-","0","+","+","+","+","+"]},{"label":"$x - 3$","cells":["-","-","-","-","-","0","+"]},{"label":"$x - 2$","cells":["-","-","-","0","+","+","+"]},{"label":"המנה","cells":["-","0","+","out","-","0","+"],"result":true}]}\n```',
  ...
  // ───────── hard · שלוש מדרגות אל תוך שאלת בגרות ─────────
  {
    ...
    solution: {
      steps: [
        ...
        '```signtable\n{"cols":[{"range":"$x < -5$"},{"point":"$x = -5$","note":"מתאפס"},{"range":"$-5 < x < 3$"},{"point":"$x = 3$","note":"מחוץ לתחום"},{"range":"$x > 3$"}],"rows":[{"label":"$x + 5$","cells":["-","0","+","+","+"]},{"label":"$3 - x$","cells":["+","+","+","0","-"]},{"label":"המנה","cells":["-","0","+","out","-"],"result":true}]}\n```',
  ...
  },
  {
    ...
    solution: {
      steps: [
        ...
        '```signtable\n{"cols":[{"range":"$x < 1$"},{"point":"$x = 1$","note":"מחוץ לתחום"},{"range":"$1 < x < 2$"},{"point":"$x = 2$","note":"מתאפס"},{"range":"$2 < x < 5$"},{"point":"$x = 5$","note":"מתאפס"},{"range":"$x > 5$"}],"rows":[{"label":"$x - 1$","cells":["-","0","+","+","+","+","+"]},{"label":"$x - 2$","cells":["-","-","-","0","+","+","+"]},{"label":"$x - 5$","cells":["-","-","-","-","-","0","+"]},{"label":"המנה","cells":["-","out","+","0","-","0","+"],"result":true}]}\n```',
  ...
  },
  {
    ...
    solution: {
      steps: [
        ...
        'שתי הנקודות מחלקות את ציר המספרים לשלושה תחומים, ובונים עליהם טבלת סימנים:',
        '```signtable\n{"cols":[{"range":"$x < -2$"},{"point":"$x = -2$","note":"מתאפס"},{"range":"$-2 < x < 6$"},{"point":"$x = 6$","note":"מחוץ לתחום"},{"range":"$x > 6$"}],"rows":[{"label":"$x + 2$","cells":["-","0","+","+","+"]},{"label":"$x - 6$","cells":["-","-","-","0","+"]},{"label":"המנה","cells":["+","0","-","out","+"],"result":true}]}\n```',
