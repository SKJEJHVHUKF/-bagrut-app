    ...
    },
    {
      ...
      tiles: [
        ...
        // ---- רמה 4 --------------------------------------------------------
        {
          ...
          bullets: ['למה בכלל צריך זהויות — מה הן מפשטות', '$\\sin(180°-\\alpha)$, $\\cos(180°-\\alpha)$ וזהות פיתגורס', 'זווית כפולה: $\\sin(2\\alpha) = 2\\sin\\alpha\\cos\\alpha$', 'משוואה בתחום, כולל הצבת $t$'],
        },
        // ---- רמה 5 --------------------------------------------------------
        {
          kind: 'ladder',
