...
export const TRACK_571: TrackTree = {
  ...
  topics: [
    ...
    },
    {
      ...
      //
      // איתי, 2026-09-08: ההיפוך הראשון. הזהויות היו שלב 1 ועברו אחרי הבסיס.
      //
      // 🔴 איתי, 2026-09-09 — הסדר הנוכחי, והוא מחליף את הקודם. הוא כתב אותו
      // כרשימה ממוספרת, וזו הרשימה:
      //   שלב 1: סינוס קוסינוס וטנגנס במשולש ישר זווית
      //   שלב 2: מעגל היחידה וזהויות טריגונומטריות
      //   שלב 3: משוואות טריגונומטריות מורכבות (זהויות + הצבת t)
      //   שלב 4: משפט הסינוסים כולל המורחב + משפט הקוסינוסים
      //   שלב 5: שטח משולש בטריגונומטריה
      //   שלב 6: שאלות ברמת בגרות
      //
      // מה שהשתנה במבנה כדי לקיים אותה:
      //  · trig-plane-basics פורק. הזהויות שלו עברו לשלב 2, המשוואות לשלב 3,
      //    ומשפטי המעגל נמחקו — "אין טעם ללמד בפרק זה משפטים במעגל מפני
      //    שלימדנו הכל בגאומטריה". שאלת הבגרות שלו הייתה שאלת מעגל וירדה איתם.
      //  · special-angles-reduction נבלע בתוך trig-identities, שהוא עכשיו
      //    שלב 2. שלבי מעגל היחידה מוקדמים בתוך השיעור, לא מצורפים בסוף:
      //    הזהויות נבנות על מעגל היחידה ולכן הוא חייב להיקרא ראשון.
      //  · משפט הסינוסים המורחב נשאר בשלב 4. איתי כתב במקום אחד להעביר אותו
      //    לשלב הבגרות והשאיר את זה לשיקול דעת, ואז כתב רשימה מפורשת שמציבה
      //    אותו בשלב 4. הרשימה הממוספרת היא המאוחרת והמחייבת.
      //
      // ⚠️ מוסכמת האותיות היווניות (אלפא/בתא/גמא) ישבה בתוך trig-plane-basics
      // כשהוא היה הראשון, והועברה לראש trig-right-triangle. אל תחזיר אותה.
      tiles: [
        // ---- שלב 1 --------------------------------------------------------
        {
          kind: 'ladder',
          subId: 'trig-right-triangle',
          title: 'שלב 1 · סינוס, קוסינוס וטנגנס במשולש ישר זווית',
          bullets: ['מול חלקי יתר, ליד חלקי יתר, מול חלקי ליד', 'למצוא את היתר', 'למצוא ניצב', 'למצוא את הזווית מהיחס'],
        },
        // ---- שלב 2 --------------------------------------------------------
        {
          kind: 'ladder',
          subId: 'trig-identities',
          title: 'שלב 2 · מעגל היחידה וזהויות טריגונומטריות',
          bullets: ['מעגל היחידה וערכים מיוחדים', 'זוויות צמצום', '$\\sin(180°-\\alpha)$ וזהות פיתגורס', 'זווית כפולה: $\\sin(2\\alpha) = 2\\sin\\alpha\\cos\\alpha$'],
        },
        // ---- שלב 3 --------------------------------------------------------
        {
          kind: 'ladder',
          subId: 'trig-equations',
          title: 'שלב 3 · משוואות טריגונומטריות מורכבות',
          bullets: ['משוואה שדורשת זהות לפני שפותרים', 'הצבת משתנה עזר $t$', 'פירוק לגורמים במקום חלוקה', 'סינון לפי התחום הנתון'],
        },
        // ---- שלב 4 --------------------------------------------------------
        {
          kind: 'ladder',
          subId: 'trig-sine-cosine-laws',
          title: 'שלב 4 · משפט הסינוסים המורחב ומשפט הקוסינוסים',
        ...
        // ---- שלב 5 --------------------------------------------------------
        {
          ...
          title: 'שלב 5 · שטח משולש בטריגונומטריה',
          bullets: ['$S = \\tfrac12 ab\\sin\\gamma$: הזווית הכלואה', 'מהשטח אל הזווית — שתי תשובות', 'שטח במרובע ובמצולע', 'הבעת שטח בפרמטר'],
        },
        // ---- שלב 6 --------------------------------------------------------
        {
          kind: 'ladder',
          subId: 'trig-plane-mixed',
          title: 'שלב 6 · שאלות ברמת בגרות',
