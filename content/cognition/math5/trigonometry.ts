...
export const trigonometryCognition: TopicCognitionMap = {
  ...
  skills: [
    ...
    { id: "special-angles-values", title: "ערכי הפונקציות בזוויות מיוחדות", subject: SUBJECT, topic: TOPIC, subTopicId: "trig-identities", prereqs: [], band: "easy" },
    { id: "quadrant-sign-reduction", title: "קביעת רבע וסימן עם זוויות צמצום", subject: SUBJECT, topic: TOPIC, subTopicId: "trig-identities", prereqs: ["special-angles-values"], band: "mid" },
