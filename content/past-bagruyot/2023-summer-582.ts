  ...
  // ===========================================================================
  {
    ...
    parts: [
      ...
      },
      {
        ...
        solution: {
          steps: [
            '$f\'(x) = n(e^x-1)^{n-1}\\cdot e^x$',
            '$f\'(x) = 0$: $\\;n e^x (e^x-1)^{n-1} = 0$',
            '$e^x \\ne 0$, אז $e^x - 1 = 0 \\Rightarrow x = 0$',
            '$f(0) = (e^0-1)^n - 4 = -4$ — נקודת חשד $(0,-4)$',
            '$n$ זוגי ($n-1$ אי-זוגי): $f\'$ עובר $(-)\\to(+)$ ב-$x=0$ → מינימום $(0,-4)$',
            '$n$ אי-זוגי ($n-1$ זוגי): $f\' \\ge 0$ תמיד → אין קיצון, נקודת פיתול אופקית $(0,-4)$',
          ],
          final_answer: '$n$ זוגי: מינימום $(0,-4)$. $\\;n$ אי-זוגי: אין קיצון (פיתול אופקי ב-$(0,-4)$)',
        },
      },
      {
        label: 'א3',
