    ...
    parts: [
      {
        ...
        hints: [
          ...
          'אחרי העלאה בריבוע ופישוט תקבל מכפלה מהצורה $y_1\\cdot(\\ldots)=0$, כלומר $y_1$ כפול ביטוי כלשהו. מכפלה שווה לאפס $\\Longrightarrow$ אחד הגורמים אפס — שני מקרים, שני ישרים.',
        ],
        solution: {
          steps: [
    ...
    parts: [
      ...
      },
      {
        ...
        hints: [
          ...
          'אחרי שתפתח, תקבל ביטוי מהצורה $\\vec{KP} = c_1\\vec{w} + c_2\\vec{u} + c_3\\vec{v}$ עם שלושה מקדמים. הנדרש $\\alpha\\vec{u}+\\beta\\vec{v}$ — אין שם $\\vec{w}$!',
