 ...
 *   Q5 — סדרות הנדסיות: סדרה I (מנה 9r^2) וסדרה II (הכנסת איבר, מנה q=3r);
 *        התכנסות, S_II=4/3·S_I → r=1/9, סכום מקומות-זוגיים=12 → a1=32,
 *        סכום מקומות כפולות-5 = 48/121, ויחס איבר/סכום-שאחריו = (1-q)/q.
 */
