      ...
      },
      {
        ...
        solution: {
          steps: [
            ...
            '$\\text{cis}\\,120°$ הוא בדיוק הפתרון $w_3$ (עבור $k=3$), ולכן $\\dfrac{z}{\\bar z}$ הוא אחד מפתרונות המשוואה. **מש״ל**',
          ],
    ...
    parts: [
      ...
      },
      {
        ...
        hints: [
          ...
          '$f\\,\' = 0$ כלומר $x = 0$ או $2 - 3x^3 = 0$ כלומר $x = \\sqrt[3]{2/3}$. בדוק סימני $f\\,\'$ מסביב לכל נקודה.',
        ],
        solution: {
          steps: [
      ...
      },
      {
        ...
        solution: {
          steps: [
            '$g\\,\'(x) = f(x)$. עלייה אם ורק אם $g\\,\' \\ge 0$ כלומר $f(x) \\ge 0$.',
            'מסעיף א1: $f \\ge 0$ לכל $x$, ושוויון רק ב-$x=0$.',
          ],
          final_answer:
            '$g$ עולה לכל $x$ ממשי (העלייה רציפה; ב-$x=0$ השיפוע אפס, אבל הפונקציה ממשיכה לעלות מסביב).',
        },
      },
      {
        label: 'ד2',
        ...
        solution: {
          steps: [
            '$g\\,\'\'(x) = f\\,\'(x)$. נקודת פיתול אם ורק אם $f\\,\'$ מתחלף בסימן.',
