    ...
    parts: [
      {
        ...
        solution: {
          steps: [
            'כדי למצוא את תחום ההגדרה נצמצם תחילה את הביטוי שבתוך הלוגריתם: מכיוון ש-$x^2-1=(x-1)(x+1)$, מתקבל $\\dfrac{(x-1)(x+1)}{(x+2)(x-1)}=\\dfrac{x+1}{x+2}$, וצמצום זה תקף כל עוד $x\\ne 1$.',
            'הפונקציה $\\ln$ מוגדרת רק עבור ערך חיובי, ולכן נדרוש $\\dfrac{x+1}{x+2}>0$. כמו כן $x\\ne 1$ (כדי שהמכנה המקורי לא יתאפס) ו-$x\\ne -2$.',
            'מנה היא חיובית כאשר המונה והמכנה בעלי אותו סימן, ולכן $\\dfrac{x+1}{x+2}>0$ מתקיים עבור $x>-1$ (שניהם חיוביים) או $x<-2$ (שניהם שליליים).',
            'בצירוף הדרישה $x\\ne 1$ מתקבל תחום ההגדרה: $(-\\infty,-2)\\cup(-1,1)\\cup(1,\\infty)$.',
          ],
          final_answer:
      ...
      },
      {
        ...
        solution: {
          steps: [
            'אסימפטוטות אנכיות מתקבלות בקצוות תחום ההגדרה. כאשר $x\\to -2^-$ המנה $\\dfrac{x+1}{x+2}$ שואפת ל-$\\dfrac{-1}{0^-}=+\\infty$, ולכן $f\\to +\\infty$, והישר $x=-2$ הוא אסימפטוטה אנכית.',
            'כאשר $x\\to -1^+$ המנה שואפת ל-$\\dfrac{0^+}{1}=0^+$, ולכן $f\\to -\\infty$, והישר $x=-1$ הוא אסימפטוטה אנכית.',
            'בנקודה $x=1$ הפונקציה אינה מוגדרת, אך שם המנה שואפת לערך הסופי $\\tfrac{2}{3}$, ולכן זהו חור בגרף ולא אסימפטוטה.',
            'לבסוף, כאשר $x\\to\\pm\\infty$ המנה שואפת ל-$1$, ולכן $f\\to\\ln 1 = 0$, והישר $y=0$ הוא אסימפטוטה אופקית.',
          ],
          final_answer:
      ...
      },
      {
        ...
        solution: {
          steps: [
            'מסעיף א1 הפונקציה היא $f(x)=\\ln\\dfrac{x+1}{x+2}$. נגזור אותה לפי הכלל $\\;(\\ln u)\'=\\dfrac{u\'}{u}\\;$ עם $u=\\dfrac{x+1}{x+2}$.',
            'נגזור תחילה את $u$ בעזרת כלל המנה: $\\;u\'=\\dfrac{1\\cdot(x+2)-(x+1)\\cdot 1}{(x+2)^2}=\\dfrac{1}{(x+2)^2}$.',
            'נציב בכלל ונקבל: $\\;f\'(x)=\\dfrac{u\'}{u}=\\dfrac{1}{(x+2)^2}\\cdot\\dfrac{x+2}{x+1}=\\dfrac{1}{(x+1)(x+2)}$.',
            'נבדוק את סימן הנגזרת בתחום ההגדרה: עבור $x<-2$ שני הגורמים $(x+1)$ ו-$(x+2)$ שליליים, ועבור $x>-1$ שניהם חיוביים — ובשני המקרים מכפלתם חיובית, ולכן $f\'(x)>0$.',
            'לכן הפונקציה עולה ממש בכל ענף של תחום ההגדרה, ואין לה תחומי ירידה ואין נקודות קיצון.',
          ],
          final_answer:
      ...
      },
      {
        ...
        solution: {
          steps: [
            'נאסוף את המידע מהסעיפים הקודמים: תחום ההגדרה הוא $(-\\infty,-2)\\cup(-1,1)\\cup(1,\\infty)$, האסימפטוטות הן $x=-2$, $x=-1$ ו-$y=0$, והפונקציה עולה ממש בכל ענף. כמו כן יש חור ב-$x=1$ (ערך גבול $\\ln\\tfrac{2}{3}$) וחיתוך עם ציר $y$ בנקודה $(0,-\\ln 2)$.',
            'הענף השמאלי, בתחום $(-\\infty,-2)$, עולה מ-$0$ (כאשר $x\\to-\\infty$) עד $+\\infty$ (כאשר $x\\to-2^-$), והוא כולו מעל ציר ה-$x$.',
            'הענף הימני, בתחום $(-1,1)\\cup(1,\\infty)$, עולה מ-$-\\infty$ (כאשר $x\\to-1^+$) עד $0$ (כאשר $x\\to+\\infty$), עובר דרך $(0,-\\ln 2)$, וכולו מתחת לציר ה-$x$, עם חור ב-$x=1$.',
          ],
          final_answer:
      ...
      },
      {
        ...
        solution: {
          steps: [
            'הפונקציה $g(x)=\\ln(f(x))$ מוגדרת רק כאשר $f(x)>0$, כלומר כאשר $\\ln\\dfrac{x+1}{x+2}>0$.',
            'אי-שוויון זה שקול ל-$\\dfrac{x+1}{x+2}>1$, שכן $\\ln t>0$ פירושו $t>1$.',
            'נעביר אגף ונאחד למכנה משותף: $\\;\\dfrac{x+1}{x+2}-1=\\dfrac{(x+1)-(x+2)}{x+2}=\\dfrac{-1}{x+2}>0$, ולכן $x+2<0$, כלומר $x<-2$.',
          ],
      ...
      },
      {
        ...
        solution: {
          steps: [
            'נגזור את $g(x)=\\ln(f(x))$ לפי כלל השרשרת לגזירת לוגריתם: $\\;g\'(x)=\\dfrac{f\'(x)}{f(x)}$.',
            'בתחום ההגדרה של $g$, כלומר עבור $x<-2$, מתקיים $f(x)>0$ — שהרי שם בדיוק $g$ מוגדרת. כמו כן, מסעיף א3, $f\'(x)=\\dfrac{1}{(x+1)(x+2)}>0$ (שני הגורמים שליליים ומכפלתם חיובית).',
            'לכן $g\'(x)$ הוא מנה של שני ביטויים חיוביים, כלומר $g\'(x)>0$, ומכאן ש-$g$ עולה ממש בכל תחום ההגדרה $(-\\infty,-2)$ — אין ירידה ואין נקודות קיצון.',
          ],
      ...
      },
      {
        ...
        solution: {
          steps: [
            'הפונקציה $g$ מוגדרת על $(-\\infty,-2)$ ועולה ממש שם, כפי שראינו בסעיף ב2.',
            'נבדוק את הקצוות: כאשר $x\\to-\\infty$ מתקיים $f\\to 0^+$, ולכן $g=\\ln f\\to-\\infty$; וכאשר $x\\to -2^-$ מתקיים $f\\to+\\infty$, ולכן $g\\to+\\infty$. מכאן שהישר $x=-2$ הוא אסימפטוטה אנכית.',
            'נמצא את החיתוך עם ציר ה-$x$: $g(x)=0$ כאשר $f(x)=1$, כלומר $\\dfrac{x+1}{x+2}=e$, ופתרון המשוואה נותן $x=\\dfrac{1-2e}{e-1}\\approx-2.58$.',
            'לסיכום, הגרף עולה ממש על כל התחום $(-\\infty,-2)$, מ-$-\\infty$ עד $+\\infty$, וחוצה את ציר ה-$x$ בנקודה $x\\approx-2.58$.',
          ],
          final_answer:
      ...
      },
      {
        ...
        solution: {
          steps: [
            'נתון $0<f(x)<1$, ולכן ראשית $f(x)>0$ — הגורם הראשון במכפלה חיובי.',
            'כעת נבדוק את הסימן של $g(x)=\\ln(f(x))$: לוגריתם טבעי של מספר שבין $0$ ל-$1$ הוא תמיד שלילי, ולכן $g(x)<0$.',
            'המכפלה היא אפוא חיובי כפול שלילי, ולכן $f(x)\\cdot g(x)<0$ — כלומר היא שלילית, ובוודאי אינה חיובית.',
          ],
          final_answer:
