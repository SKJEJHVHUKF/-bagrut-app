...
const SHOWS =
  /מעלים|מחלקים|כופלים|מצמצמים|מכנסים|מכניסים|מציבים|פותחים|מעבירים|לפי הנוסחה|החזקה החדשה|נגזרת פנימית|כלל המנה|נגזרת מנה|גוזרים|מפרקים|פותרים|מכנה משותף|בהצלבה|לפי הכלל/;
