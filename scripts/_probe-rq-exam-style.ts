...
const EXAM_ASK =
  /מצא|חשב|הוכיח|הראו|סרטט|שרטט|קבע|נמק|מהו|מהי|מהם|מהן|עבור אילו ערכים|רשמ|הסבירו מדוע|גזור|גזר|פתור|פתר|בדוק|בדק|כמה [^?]*יש|באיז[הו] [^?]*\?|בין אילו ערכים|מה תחום|כתוב|כתב(?:ו) את|לאיזו|איזו נקודה|איזו מהפונקציות|לאן/;
