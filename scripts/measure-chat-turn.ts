...
/**
 * Observed answer length. There is no single cap any more: route.ts prices a
 * turn against a tiered budget (REPLY_TOKENS_NUDGE 200 / _CONCEPT 400 / _FULL
 * 500), so 380 sits at a normal concept reply — the honest typical case, not a
 * ceiling. Re-read those constants before trusting a number printed here.
 */
