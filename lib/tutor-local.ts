...
const TEMPLATES: Record<string, Tpl> = {
  ...
  'A:help:hint': T(
    'hint',
    'רגע לפני שאתה בוחר — {hint}\n\nעכשיו עבור על האפשרויות ומחק כל אחת שלא עומדת בזה. מה נשאר?',
    'רגע לפני שאתה בוחר: כתוב בשורה נפרדת מה השאלה דורשת שיתקיים, ורק אז תסתכל באפשרויות. איזו מהן לא עומדת בדרישה הזאת?',
  ),
  'A:help:first-step': T(
    'first-step',
    'הצעד הראשון כאן הוא זה:\n\n{firstStep}\n\nכתוב אותו אצלך עם המספרים של השאלה. אחריו נשארו עוד {stepsLeft} צעדים, וכולם שלך — עשה את הבא ותגיד לי מה יצא.',
  ...
  'A:full': T(
    'full',
    'בסדר, פותחים הכל. ככה זה נפתר:\n\n{steps}\n\n**התשובה: {finalAnswer}**\n\n**למה זה עובד:** {explanation}\n\nעכשיו תעשה לי טובה אחת: סגור את זה ופתור אותה שוב מאפס. פתרון שקראת אינו פתרון שאתה יודע.',
    'בסדר, פותחים הכל. ככה זה נפתר:\n\n{steps}\n\n**התשובה: {finalAnswer}**\n\nעכשיו תעשה לי טובה אחת: סגור את זה ופתור אותה שוב מאפס. פתרון שקראת אינו פתרון שאתה יודע.',
  ),
  'A:formulas': T(
    'formulas',
    'הנוסחאות שהשאלה הזאת יושבת עליהן, מתוך {title}:\n\n{formulas}\n\nתסתכל בשאלה ותשאל מה נתון לך — הנוסחה שכל האיברים שלה נתונים חוץ מאחד היא זו שאתה צריך.',
    'אין לי כאן דף נוסחאות למסך הזה. תגיד לי איזה ביטוי בשאלה אתה לא יודע לפתוח, ונתחיל ממנו.',
  ),
  'A:key-points': T(
    'key-points',
    'מה שחשוב לזכור ב{title}:\n\n{keyPoints3}\n\nקח את הראשון מהם ובדוק אותו מול השאלה שעל המסך — הוא מתקיים שם?',
    'אין לי כאן רשימת דגשים למסך הזה. כתוב בשתי שורות מה השאלה הזאת בודקת לדעתך, ואני אגיד לך אם קלעת.',
  ),
  'A:why-wrong': T(
    'why-wrong',
    'עוד לא נרשמה כאן תשובה שלך, אז אין לי מה להשוות מולה — ולא אנחש. מה שכן יש: {hint}\n\nתבדוק מול המשפט הזה את האפשרות שאתה שוקל — היא עומדת בו?',
    'עוד לא נרשמה כאן תשובה שלך, אז אין לי מה להשוות מולה — ולא אנחש. תגיד לי איזו אפשרות אתה שוקל ולמה, ונבדוק אותה יחד.',
  ),

  // ---- B · MCQ wrong, authored note ----------------------------------
  'B:why-wrong': T(
    'why-wrong',
    'בחרת {chosenText}, ואני רואה בדיוק מה הלך שם. {note}\n\nתסתכל שוב באפשרויות עם התיקון הזה ביד — מה אתה לוקח עכשיו?',
    'בחרת {chosenText}. אין לי כאן הסבר כתוב לטעות המסוימת הזאת, ואני לא רוצה לנחש — אז נבדוק אותה ישירות: הצב את מה שסימנת בחזרה בשאלה ועבור על התנאים אחד אחד. איזה מהם נשבר ראשון?',
  ),
  'B:help:hint': T(
    'hint',
    'אתה כבר יודע אפשרות אחת שלא עובדת — זאת התקדמות, לא נסיגה. ניקח את זה מהכלל עצמו: {hint}\n\nעבור על האפשרויות ופסול כל אחת שנופלת באותה נקודה. מה נשאר?',
    'אתה כבר יודע אפשרות אחת שלא עובדת — זאת התקדמות, לא נסיגה. עכשיו הצב את התשובה שסימנת בחזרה בשאלה ובדוק אם היא מקיימת את מה שהשאלה דורשת. אם לא — אותה בדיקה תפסול לך עוד אפשרויות.',
  ),
  'B:help:first-step': T(
    'first-step',
    'נעזוב את האפשרויות רגע ונפתור מאפס. הצעד הראשון:\n\n{firstStep}\n\nאחריו נשארו עוד {stepsLeft} צעדים. עשה את הבא, ואז נשווה למה שסימנת.',
    'נעזוב את האפשרויות רגע ונפתור מאפס: כתוב בשורה נפרדת מה השאלה דורשת שיתקיים, בלי להסתכל על התשובות. מה יצא לך?',
  ),
  'B:help:key-points': T(
    'key-points',
    'נעזוב את האפשרויות רגע. השאלה הזאת קצרה מכדי לתת צעד ראשון בלי לתת את הסוף, אז הנה הכללים שהיא נשענת עליהם:\n\n{keyPoints3}\n\nבדוק מולם את {chosenText} — היא עומדת בהם או נופלת?',
    'נעזוב את האפשרויות רגע. הצב את התשובה שסימנת בחזרה בשאלה ועבור על התנאים אחד אחד — איזה מהם נשבר ראשון?',
  ),
  'B:full': T(
    'full',
    'בוא נפרוס את זה מהתחלה:\n\n{steps}\n\n**התשובה: {finalAnswer}**\n\n**למה זה עובד:** {explanation}\n\nעכשיו תגיד לי במילים שלך באיזה צעד {chosenText} נפרדת מהפתרון הזה.',
    'בוא נפרוס את זה מהתחלה:\n\n{steps}\n\n**התשובה: {finalAnswer}**\n\nעכשיו תגיד לי במילים שלך באיזה צעד התשובה שסימנת נפרדה מהפתרון הזה.',
  ),
  ...
  'C:why-wrong': T(
    'why-wrong',
    'בחרת {chosenText}. אין לי כאן הסבר כתוב לטעות המסוימת הזאת, ואני לא רוצה לנחש מה עבר לך בראש — אז ניקח את זה בדרך שעובדת תמיד: {hint}\n\nהעבר את {chosenText} דרך הדרישה הזאת — איפה בדיוק היא נשברת?',
    'בחרת {chosenText}. אין לי כאן הסבר כתוב לטעות המסוימת הזאת, ואני לא רוצה לנחש — אז נבדוק אותה ישירות: הצב את מה שסימנת בחזרה בשאלה ועבור על התנאים אחד אחד. איזה מהם נשבר ראשון?',
  ),
  ...
  'D:full': T(
    'full',
    'הפתרון כבר פתוח לפניך, אז במקום לחזור עליו — הנה השלד שלו:\n\n{steps}\n\n**למה זה עובד:** {explanation}\n\nעכשיו כסה את המסך וכתוב לי את הצעד הראשון מהזיכרון. אם הוא יוצא, השאר יוצא איתו.',
  ...
  'E:why-wrong:extra-root': T(
    'why-wrong',
    'קראתי את מה שכתבת: {studentAnswer}. האלגברה שלך תקינה, וכל מה שכתבת מקיים את המשוואה שגזרת — אבל מה שמקיים את המשוואה הוא לא בהכרח פתרון של השאלה.\n\nקח כל ערך שכתבת בנפרד והצב אותו בשאלה המקורית, לא במשוואה. איזה מהם לא חוקי שם?',
    'האלגברה שלך תקינה, וכל מה שכתבת מקיים את המשוואה שגזרת — אבל מה שמקיים את המשוואה הוא לא בהכרח פתרון של השאלה. הצב כל ערך בנפרד בשאלה המקורית: איזה מהם לא חוקי שם?',
  ),
  ...
  'E:why-wrong': T(
    'why-wrong',
    'קראתי את מה שכתבת: {studentAnswer}. זה לא יוצא, אבל צורת ההפרש לא מספרת לי לבד איפה זה נשבר, ואני לא רוצה לנחש.\n\nכתוב לי את השורה האחרונה שאתה בטוח בה, ונמשיך משם.',
    'קראתי את מה שכתבת, וזה לא יוצא — אבל אני לא רוצה לנחש איפה. כתוב לי את השורה האחרונה שאתה בטוח בה, ונמשיך משם.',
  ),
  'E:help:hint': T(
    'hint',
    'כתבת {studentAnswer} — נשאיר את זה בצד רגע. {hint}\n\nהרץ את הרמז הזה על השורה האחרונה שכתבת: היא שורדת אותו?',
    'נשאיר את מה שכתבת בצד רגע ונעשה את הבדיקה שתמיד עובדת: הצב את מה שכתבת בחזרה לתוך השאלה עצמה. מה לא מסתדר?',
  ),
  ...
  'F:why-wrong': T(
    'why-wrong',
    'אתה אומר שזה לא יצא, ואני לא רואה את הדף שלך — אז לא אנחש איפה זה נשבר. אבל זה מה שהשאלה נשענת עליו: {hint}\n\nאל תתחיל מחדש — עבור על מה שכתבת ומצא את השורה הראשונה שלא עומדת במשפט הזה.',
    'אתה אומר שזה לא יצא, ואני לא רואה את הדף שלך — אז לא אנחש איפה זה נשבר. אל תתחיל מחדש: עבור על מה שכתבת ומצא את השורה הראשונה שאתה לא יכול להצדיק, וכתוב לי אותה.',
  ),

  // ---- G · open question, not answered yet ---------------------------
  'G:help:hint': T(
    'hint',
    'עוד לא כתבת כלום, וזה הרגע הכי טוב לרמז — הוא שווה יותר לפני שהדף מתמלא. {hint}\n\nרשום שורה אחת בעקבותיו: לא את הפתרון, רק את התנאי או המשוואה שהוא מכתיב.',
    'עוד לא כתבת כלום, וזה בסדר גמור. נתחיל מהמקום שתמיד עובד: רשום בשורה אחת מה נתון ובשורה שנייה מה מבקשים ממך. שלח לי את שתי השורות.',
  ),
  'G:help:first-step': T(
    'first-step',
    'הצעד הראשון בשאלה הזאת:\n\n{firstStep}\n\nכתוב אותו אצלך עם המספרים של השאלה. אחריו נשארו עוד {stepsLeft} צעדים — עשה את הבא ותגיד לי מה יצא.',
  ...
  'H:help': T(
    'hint',
    'אין לי שאלה על המסך לתפוס בה, ו"תקוע" לבד עוד רחב מדי בשביל רמז. הנה העיקר של {title}:\n\n{keyPoint1}\n\nתגיד לי אם המשפט הזה מרגיש לך מובן מאליו או לא — התשובה תקבע מאיפה נתחיל.',
    'אין לי כאן שאלה על המסך לתפוס בה. פתח תרגיל אחד מהנושא, אפילו קל, ותגיד לי איפה הוא נעצר — על שאלה קונקרטית אני הרבה יותר שימושי.',
  ),
  'H:key-points': T(
    'key-points',
    'אין עכשיו שאלה על המסך, אז ניקח את זה מלמעלה. מה שחשוב לזכור ב{title}:\n\n{keyPoints3}\n\nבחר את זה שהכי פחות ברור לך וכתוב לי אותו — משם נצא לתרגול ממוקד.',
    'אין לי כאן רשימת דגשים למסך הזה. כתוב לי איזה חלק בנושא הזה מרגיש לך הכי רעוע, ונתחיל בדיוק ממנו.',
  ),
  'H:formulas': T(
    'formulas',
    'אין עכשיו שאלה על המסך, אז זה בדיוק הזמן לעבור על הנוסחאות של {title}:\n\n{formulas}\n\nבחר אחת ותגיד לי באיזה סוג שאלה היא נכנסת — לדעת מתי שווה יותר מלדעת בעל-פה.',
    'אין לי כאן דף נוסחאות למסך הזה. תגיד לי איזה גודל אתה מנסה לחשב, ואני אכוון אותך לנוסחה שמתאימה לו.',
  ),
  'H:full': T(
    'full',
    'אין כרגע שאלה על המסך שאפשר לפתור. בחר תרגיל אחד מ{title} ונעבור עליו צעד-צעד — איזה מהם?',
    'אין כרגע שאלה על המסך שאפשר לפתור. פתח תרגיל ואני אעבור עליו איתך צעד-צעד.',
  ),
  'H:why-wrong': T(
    'why-wrong',
    'אני לא רואה כרגע את השאלה שטעית בה. תכתוב לי מה ענית, ונתחיל משם.',
    'אני לא רואה כרגע את השאלה שטעית בה. תכתוב לי מה ענית, ונתחיל משם.',
  ),
  ...
  'ANY:help': T(
    'hint',
    'עברנו כבר על הרמז ועל הכללים, ואתה עדיין תקוע — זה בדרך כלל סימן שהנקודה התקועה היא לא באף אחד מהם. כתוב לי את השורה האחרונה שהצלחת לכתוב, גם אם אתה לא בטוח בה, ונמשיך משם.',
    'עברנו כבר על הרמז ועל הכללים, ואתה עדיין תקוע — זה בדרך כלל סימן שהנקודה התקועה היא לא באף אחד מהם. כתוב לי את השורה האחרונה שהצלחת לכתוב, גם אם אתה לא בטוח בה, ונמשיך משם.',
  ),
  ...
  'I:any': T(
    'hint',
    'אני רואה שיש כאן שאלה, אבל לא את הפירוק שלה — אז לא אמציא צעדים. תכתוב לי איזה סעיף אתה עושה ומה השורה האחרונה שיצאה לך, ונמשיך משם.',
    'אני רואה שיש כאן שאלה, אבל לא את הפירוק שלה — אז לא אמציא צעדים. תכתוב לי איזה סעיף אתה עושה ומה השורה האחרונה שיצאה לך, ונמשיך משם.',
  ),
};
